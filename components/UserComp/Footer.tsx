...
export default function Footer() {
  ...
  return (
    <footer className="text-gray-800 bg-white  mt-12 relative">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 grid grid-cols-1 sm:grid-cols-2 gap-8">

        <div className="space-y-4 relative sm:w-[80%]">
        ...
        <div className="flex justify-between">
          <div className="flex flex-col space-y-3 md:mt-2 mb-10">
          ...
          <div className="flex gap-3 flex-col md:mr-10">
