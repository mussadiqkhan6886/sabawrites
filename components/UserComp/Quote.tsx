...
const Quote = () => {
  return (
    <section className='py-10 max-w-6xl relative mx-auto h-[90vh]'>
      {/* stickers */}
        <Image src={"/girl-power (1).png"} alt='girl power one sticker' width={70} height={70} className='absolute left-0 -top-5' />
        <Image src={"/girl-power.png"} alt='girl power two sticker' width={70} height={70} className='absolute right-0 bottom-0' />
      {/* end */}
